...
**PM/Tech Pal** is an **AI-powered learning companion** providing **structured mentorship, socratic tutoring, and mock interview simulation** for **aspiring and transitioning Tech Talents**. It leverages AI to offer **personalized learning paths, real-time feedback, and interactive interview practice**. Users interact with PM Pal through **Telegram** with natural language — both voice and text. 
